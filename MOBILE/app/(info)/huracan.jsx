    ...
    <View style={styles.outerContainer}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.detailsContainer}>
          <Text style={styles.carName}>Lamborghini Huracán</Text>
          ...
          <Text style={styles.description}>
            The Lamborghini Huracán offers a balance of performance and elegance.
            Its V10 engine, aerodynamic design, and premium interior make it a favorite
            among enthusiasts seeking luxury and speed in one package.
          </Text>
          ...
          <View style={styles.features}>
            ...
            <View>
              <Text style={styles.feature}>• Bluetooth Audio</Text>
              <Text style={styles.feature}>• Carbon Fiber Interior</Text>
              <Text style={styles.feature}>• Rear Camera</Text>
            </View>
          </View>
        </View>
      </ScrollView>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/book/huracan")}
      >
